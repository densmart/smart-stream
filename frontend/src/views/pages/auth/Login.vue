...
const handleSignIn = async () => {
    if (!login.value || !password.value) {
        errorMessage.value = 'Please enter login and password';
        return;
    }
    ...
    try {
        ...
        authApi.setToken(response.result.access_token);
        router.push('/');
    } catch (err) {
        errorMessage.value = err.response?.data?.error || 'Failed to sign in';
    } finally {
        loading.value = false;
    }
};
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Welcome to Smart Stream!</div>
